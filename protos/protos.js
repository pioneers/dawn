...
export const Param = ($root.Param = (() => {
  ...
  Param.encode = function encode(message, writer) {
    ...
    if (message.fval != null && message.hasOwnProperty('fval')) writer.uint32(/* id 2, wireType 5 =*/ 21).float(message.fval);
    if (message.ival != null && message.hasOwnProperty('ival')) writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.ival);
    if (message.bval != null && message.hasOwnProperty('bval')) writer.uint32(/* id 4, wireType 0 =*/ 32).bool(message.bval);
    return writer;
  };
...
export const Device = ($root.Device = (() => {
  ...
  Device.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.name != null && message.hasOwnProperty('name')) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.name);
    if (message.uid != null && message.hasOwnProperty('uid')) writer.uint32(/* id 2, wireType 0 =*/ 16).uint64(message.uid);
  ...
  Device.fromObject = function fromObject(object) {
    ...
    if (object.name != null) message.name = String(object.name);
    if (object.uid != null)
      if ($util.Long) (message.uid = $util.Long.fromValue(object.uid)).unsigned = true;
      ...
      else if (typeof object.uid === 'object') message.uid = new $util.LongBits(object.uid.low >>> 0, object.uid.high >>> 0).toNumber(true);
      ...
      if (typeof message.uid === 'number') object.uid = options.longs === String ? String(message.uid) : message.uid;
        ...
        object.uid =
          options.longs === String
            ...
            ? new $util.LongBits(message.uid.low >>> 0, message.uid.high >>> 0).toNumber(true)
            : message.uid;
...
export const GpState = ($root.GpState = (() => {
  ...
  GpState.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.connected != null && message.hasOwnProperty('connected')) writer.uint32(/* id 1, wireType 0 =*/ 8).bool(message.connected);
    if (message.buttons != null && message.hasOwnProperty('buttons')) writer.uint32(/* id 2, wireType 5 =*/ 21).fixed32(message.buttons);
  ...
  GpState.verify = function verify(message) {
    ...
    if (message.connected != null && message.hasOwnProperty('connected'))
      if (typeof message.connected !== 'boolean') return 'connected: boolean expected';
    if (message.buttons != null && message.hasOwnProperty('buttons'))
      if (!$util.isInteger(message.buttons)) return 'buttons: integer expected';
  ...
  GpState.fromObject = function fromObject(object) {
    if (object instanceof $root.GpState) return object;
    let message = new $root.GpState();
    if (object.connected != null) message.connected = Boolean(object.connected);
    if (object.buttons != null) message.buttons = object.buttons >>> 0;
    if (object.axes) {
      if (!Array.isArray(object.axes)) throw TypeError('.GpState.axes: array expected');
      message.axes = [];
  ...
  GpState.toObject = function toObject(message, options) {
    ...
    if (message.buttons != null && message.hasOwnProperty('buttons')) object.buttons = message.buttons;
...
export const RunMode = ($root.RunMode = (() => {
  ...
  RunMode.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.mode != null && message.hasOwnProperty('mode')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.mode);
    return writer;
  };
...
export const StartPos = ($root.StartPos = (() => {
  ...
  StartPos.encode = function encode(message, writer) {
    if (!writer) writer = $Writer.create();
    if (message.pos != null && message.hasOwnProperty('pos')) writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.pos);
    return writer;
  };
...
export const Text = ($root.Text = (() => {
  ...
  Text.encode = function encode(message, writer) {
    ...
    if (message.payload != null && message.payload.length)
      for (let i = 0; i < message.payload.length; ++i) writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.payload[i]);
    return writer;
  };
