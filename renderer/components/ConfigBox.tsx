...
export const ConfigBoxComponent = (props: Props) => {
  ...
  return (
    <Modal backdrop="static" show={shouldShow} onHide={handleClose} animation={false}>
      <Form action="" onSubmit={saveChanges}>
        ...
        <Modal.Footer>
          <Button type="button" onClick={handleClose} variant="danger" disabled={disableUploadUpdate()}>
            Cancel
          </Button>
